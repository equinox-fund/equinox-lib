...
//TODO: FIX CONTAINER REF PROBLEM
// tooltipContainerRef should not be here or using a context
...
const Popper: React.FC<PopperProps> = ({
  ...
  // const { tooltipContainerRef } = useContext(LayoutContext)
        ...
        {({ props, arrowProps }) => (
          <div css={styles({ placement })}>
            <div
              ...
              className={classmames('popper', className)}
              {...props}
            >
