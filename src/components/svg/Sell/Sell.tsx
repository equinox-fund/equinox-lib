...
const Sell: React.FC<SellProps> = ({ className, disabled = false }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M17.1688 5.15524C18.2771 6.26355 18.2771 8.06047 17.1688 9.16878C16.0605 10.2771 14.2636 10.2771 13.1553 9.16878C12.047 8.06047 12.047 6.26355 13.1553 5.15524C14.2636 4.04693 16.0605 4.04693 17.1688 5.15524"
        stroke={getStroke()}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
